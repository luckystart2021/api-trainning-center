...
var ContactWhere = struct {
	...
	ID:        whereHelperint{field: "\"contact\".\"id\""},
	Fullname:  whereHelperstring{field: "\"contact\".\"fullname\""},
	Phone:     whereHelperstring{field: "\"contact\".\"phone\""},
	Email:     whereHelpernull_String{field: "\"contact\".\"email\""},
	Message:   whereHelperstring{field: "\"contact\".\"message\""},
	Subject:   whereHelpernull_String{field: "\"contact\".\"subject\""},
...
var (
	contactAllColumns            = []string{"id", "fullname", "phone", "email", "message", "subject", "created_at"}
	contactColumnsWithoutDefault = []string{"fullname", "phone", "email", "message", "subject"}
	contactColumnsWithDefault    = []string{"id", "created_at"}

...
var UserWhere = struct {
	...
	Sex:         whereHelperstring{field: "\"users\".\"sex\""},
	Dateofbirth: whereHelperstring{field: "\"users\".\"dateofbirth\""},
...
func (o *User) Articles(mods ...qm.QueryMod) articleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"articles\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadArticles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`articles`), qm.WhereIn(`articles.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}

...
var AlbumWhere = struct {
	...
	Meta: whereHelperstring{field: "\"album\".\"meta\""},
}
...
var (
	albumAllColumns            = []string{"id", "name", "meta"}
	albumColumnsWithoutDefault = []string{"name", "meta"}
...
func (o *Album) Photos(mods ...qm.QueryMod) photoQuery {
...
func (albumL) LoadPhotos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAlbum interface{}, mods queries.Applicator) error {
	var slice []*Album
	var object *Album
	...
	query := NewQuery(qm.From(`photos`), qm.WhereIn(`photos.album_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Album) AddPhotos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Photo) error {
	var err error

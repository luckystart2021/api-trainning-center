...
func Router(db *sql.DB) func(chi.Router) {
	...
	return func(router chi.Router) {
		...
		router.Get("/{meta_parent}/{meta_child}/{id_child_category}/list/child-news", GetChildArticles(st))
		router.Get("/{meta_parent}/{meta_child}/{id_child_category}/list/child-news/pagination", GetChildArticlesPagination(st))
	}
}

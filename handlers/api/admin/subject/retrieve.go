...
func getSubjects(service subject.ISubjectService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		showSubjects, err := service.ShowSubjects()
		if err != nil {
...
func getSubject(service subject.ISubjectService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		showTeachers, err := service.ShowSubject(idSubject)
		if err != nil {
			response.RespondWithError(w, http.StatusInternalServerError, err)
			return
		}

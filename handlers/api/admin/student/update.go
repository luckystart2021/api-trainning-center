...
func UpdateStudent(service student.IStudentService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := service.UpdateStudent(idStudent, req.Sex, req.DateOfBirth, req.Phone, req.Address, req.FullName, userRole.UserName, req.IdClass, req.CMND, req.CNSK, req.GPLX, req.Exp, req.NumberOfKm, req.IdRole)
		if err != nil {
			response.RespondWithError(w, http.StatusBadRequest, err)
			return
		}
